...
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
    ...
    # Local fallback: use the VS 2022 Llvm if the active VS instance lacks it
    if(NOT _lfs_clang_cl)
        set(_lfs_clang_cl_candidate "C:/Program Files (x86)/Microsoft Visual Studio/2022/BuildTools/VC/Tools/Llvm/x64/bin/clang-cl.exe")
        if(EXISTS "${_lfs_clang_cl_candidate}")
            set(_lfs_clang_cl "${_lfs_clang_cl_candidate}")
        endif()
    endif()
    ...
    get_filename_component(_lfs_clang_dir "${_lfs_clang_cl}" DIRECTORY)
    file(WRITE "${_lfs_clang_native_file}"
        "[binaries]\n"
        "c = ['${_lfs_clang_cl}']\n"
        "cpp = ['${_lfs_clang_cl}']\n"
        "c_ld = ['${_lfs_clang_dir}/lld-link.exe']\n"
        "cpp_ld = ['${_lfs_clang_dir}/lld-link.exe']\n")
